 ...
 */
package com.radionama.samplevoicechanger.visualizer.renderer;


import com.radionama.samplevoicechanger.visualizer.AudioData;
import com.radionama.samplevoicechanger.visualizer.FFTData;
...
public class CircleRenderer extends Renderer {
    ...
    private float[] toPolar(float[] cartesian, Rect rect) {
        ...
        double radius =
                ((rect.width() / 2) * (1 - aggresive) + aggresive * cartesian[1] / 2) * (1.2 + Math
                        .sin(modulation)) / 2.2;
        float[] out = {
