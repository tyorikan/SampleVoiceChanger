 ...
 */
package com.radionama.samplevoicechanger.visualizer;


import com.radionama.samplevoicechanger.visualizer.renderer.Renderer;
...
public class VisualizerView extends View {
    ...
    private void init() {
        ...
        mFadePaint.setColor(Color.argb(238, 255, 255,
                255)); // Adjust alpha to change how quickly the image fades
    ...
    public void link(AudioTrack audioTrack) {
        if (audioTrack == null) {
            throw new NullPointerException("Cannot link to null AudioRecord");
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCanvasBitmap == null) {
            mCanvasBitmap = Bitmap
                    .createBitmap(canvas.getWidth(), canvas.getHeight(), Config.ARGB_8888);
        }
        if (mCanvas == null) {
